...
<input type="text" name="" id="userid" value="{Client/ClientID}" style="display:none;"/>
                                                ...
                                                <form>
                                                    <div class="row mb-3">
                                                        <div class="col-md-12">
                                                            ...
                                                            <input type="text" class="form-control caseno" id="exampleInputEmail1" placeholder="Enter your Case Number for Serve"/>
                                                        ...
                                                        <div class="newcasediv" style="display:none">
                                                            ...
                                                            <div class="col-md-12" id="definpdiv">
                                                                ...
                                                                <input type="text" class="form-control" id="definp" placeholder="Defendant" style="width:45%;"/>
                                                            </div>
                                                            ...
                                                            <div class="col-md-12" id="plaininpdiv">
                                                                ...
                                                                <input type="text" class="form-control" id="plaininp" placeholder="Plaintiff" style="width:45%;"/>
                                                            </div>
                                                            <div class="col-md-12">
                                                                <div class="row">
                                                ...
                                                <form action="#" method="post" id="hockey">
                                                    <div class="row mb-3">                             
                                                        ...
                                                        <div class="col-md-5 mb-3">
                                                            <button type="button" class="btn add-party" data-bs-toggle="modal" data-bs-target="#addprtymodal">Add Party(s)</button>
                                                        </div>
                                                        ...
                                                        <div class="form-group text-center mar-b-0">
                                                            <input type="button" value="BACK" class="btn btn-dark back text-white" style="background-color:#212529"/>
                                                            <input type="button" value="NEXT" id="csepartnext" class="btn btn-primary next text-white" style="background-color:#0d6efd"/>
                                                        </div>
                                                    </div>
                                                </form>
                                            </div>
                                            ...
                                            <div class="form-container animated border shadow p-4">
                                                <div id="1srvadrdiv">
                                                    <div class="row mb-3">
                                                        <div class="col-md-6 position-relative">
                                                            <a href="#" class="vrfy-cd" data-bs-toggle="modal" data-bs-target="#addadrmodal" data-bs-whatever="@mdo" style="padding:3px;color:green;"><i class="fa fa-plus" aria-hidden="true"></i></a>
                                                            <input type="text" class="form-control srchaddr" id="srchaddr_0" placeholder="Address*" style="width:153%;"/>
                                                        </div>
                                                        <!-- ======================================================================= -->
                                                    ...
                                                    <div class="col-md-6">
                                                        <input type="text" class="form-control" id="busname_0" placeholder="Business Name"/>
                                                    </div>
                                                    <div class="row mb-3 mt-4">
                                                        <div class="col-md-6">
                                                            <label>Time Zone</label>
                                                        ...
                                                        <div class="col-md-6 mb-3">
                                                            <label>Proof : </label>
                                                            <div class="form-check form-check-inline">
                                                                <input class="form-check-input" type="radio" name="proofrdo_0" id="prffile_0" value="file" style="appearance: auto;"/>
                                                                <label class="form-check-label" for="prffile_0">File <span style="font-size: 11px; color: #000;">(Additional fee will apply)</span></label>
                                                            </div>
                                                            <div class="form-check form-check-inline">
                                                                <input class="form-check-input" type="radio" name="proofrdo_0" id="prfnotrz_0" value="notrz" style="appearance: auto;"/>
                                                            ...
                                                            <xsl:for-each select="Client/Attorneys/Attorney">
                                                                <xsl:choose><xsl:when test="Attorney!='NONE'">
                                                                    <div style="padding:5px;width:200px;height:33px;margin:0;">
                                                                        <input type="checkbox" name="reqatrchk" id="{AttorneyID}/at" value="{AttorneyID}/at"/><label for="{AttorneyID}/at"><xsl:value-of select="Attorney"/></label>
                                                                    </div>
                                                                </xsl:when></xsl:choose>
                                                            </xsl:for-each>
                                                            <xsl:for-each select="Client/Secretaries/Secretary">
                                                                <xsl:choose><xsl:when test="Secretary!='NONE'">
                                                                    <div style="padding:5px;width:200px;height:33px;margin:0;">
                                                                        <input type="checkbox" name="reqatrchk" id="{SecretaryID}/req" value="{SecretaryID}/req"/><label for="{SecretaryID}/req"><xsl:value-of select="Secretary"/></label>
                                                                    </div>
                                                                </xsl:when></xsl:choose>
                                                            </xsl:for-each>
                                                        </div>
        ...
        <div class="modal-content" style="background-color:white !important;width:100%;">
            ...
            <div class="modal-body">
                <div class="row mb-3" style="margin-left:30px;">
                    ...
                    <div class="form-group text-center mar-b-0">
                        <input type="button" id="addprty" value="SAVE" class="btn btn-dark back text-white"/>
