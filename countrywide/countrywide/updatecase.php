...
$jobinstancearr=$_POST['jobinstancearr'];
$exservnum=$_POST['exservnum'];
...
<auth>
    ...
    <Servees>
        ...
        <exJobIDs>".$jobinstancearr."</exJobIDs>
        <exJobnums>".$exservnum."</exJobnums>
        <exfileid>".$exfileid."</exfileid>
