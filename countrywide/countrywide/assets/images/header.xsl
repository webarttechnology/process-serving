	...
	<div class="wrapper">
		...
		<div class="sidebar-wrapper" data-simplebar="true">
			<div class="sidebar-header">
				<div>
					<img src=src="assets/images/countrywide_logonew.svg" class="logo-icon" alt="logo_countrywide" />
				</div>
				<xsl:comment><div>
				...
				<nav class="navbar navbar-expand">
					...
					<div class="search-bar flex-grow-1">
						...
						<div class="position-relative search-bar-box">
							...
							<div class="topbar__search"><input type="text" class="form-control search-control" placeholder="Type to search..."/> <span><i class='bx bx-search'></i></span></div>
